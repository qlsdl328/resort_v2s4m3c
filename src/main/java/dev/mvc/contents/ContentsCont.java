...
/*  @RequestMapping(value="/contents/list.do", method=RequestMethod.GET )
 ...
 /* @RequestMapping(value = "/contents/list.do", 
  ...
  public ModelAndView list_by_cateno_search(
      @RequestParam(value="cateno", defaultValue="1") int cateno, //기본값 1
...
/*  @RequestMapping(value="/contents/delete.do", method=RequestMethod.GET )
  ...
  public ModelAndView list_by_memberno(int memberno) {
    ...
    //Type 1 같은 방법 3개 join
    MemberVO memberVO = this.memberProc.read(memberno);    
    List<Cate_Contents_VO> list = this.contentsProc.cate_contents_memberno_list(memberno);
    mav.addObject("memberVO", memberVO); 
    mav.addObject("list", list); 
    
    //Type 2 같은 방법 3개 join 단점: VO를 더 만들어주어야 한다
//    Cate_Contents_MemberVO vo = new Cate_Contents_MemberVO();
//    vo.setMemberVO(memberVO);
//    vo.setCate_contents_memberno_list(list);
//    mav.addObject("vo", vo); 
    

    mav.setViewName("/contents/list_by_memberno"); // /webapp/contents/list.jsp
    return mav;
  }  
  ...
  public ModelAndView youtube_create(int cateno, int contentsno) {
    ...
    mav.setViewName("/contents/youtube_create"); // webapp/contents/map_create.jsp
  ...
  public ModelAndView mp3_create(HttpServletRequest request, 
    ...
    this.contentsProc.mp3(hashMap); // youtube 등록
  ...
  public ModelAndView mp3_delete(int cateno, int contentsno) {
    ...
    mav.setViewName("/contents/mp3_delete"); // webapp/contents/mp3_create.jsp
  ...
  public ModelAndView mp3_delete_proc(HttpServletRequest request,
    ...
    Tool.deleteFile(upDir, contentsVO.getMp3());  // Folder에서 1건의 파일 삭제
  ...
  public ModelAndView mp4_create(int cateno, int contentsno) {
    ...
    mav.setViewName("/contents/mp4_create"); // webapp/contents/mp3_create.jsp
  ...
  public ModelAndView mp4_create(HttpServletRequest request, 
    ...
    this.contentsProc.mp4(hashMap); // youtube 등록
  ...
  public ModelAndView mp4_delete(int cateno, int contentsno) {
    ...
    mav.setViewName("/contents/mp4_delete"); // webapp/contents/mp3_create.jsp
  ...
  public ModelAndView mp4_delete_proc(HttpServletRequest request,
    ...
    Tool.deleteFile(upDir, contentsVO.getMp4());  // Folder에서 1건의 파일 삭제
  ...
  public ModelAndView list_by_cateno_search_paging(
    ...
    //mav.setViewName("/contents/list_by_cateno_search_paging_img_grid1");  //갤러리형
    //mav.setViewName("/contents/list_by_cateno_search_paging_img_table1");   //테이블 기반 텍스트
    //mav.setViewName("/contents/list_by_cateno_search_paging_img_table2");  // 테이블 기반 이미지 목록
    mav.setViewName("/contents/list_by_cateno_search_paging_img_table3");   //테이블 기반 답변형
  ...
  public ModelAndView reply(int cateno, int contentsno) {
    ...
    CategrpVO categrpVO = this.categrpProc.read(cateVO.getCategrpno());
    System.out.println(cateVO.getCategrpno());
    mav.addObject("categrpVO", categrpVO);
 ...
 // --------------------------- 답변 관련 코드 시작 --------------------------
    ...
    contentsVO.setAnsnum(parentVO.getAnsnum() + 1); // 부모 바로 아래 등록 //끼어들기
    // --------------------------- 답변 관련 코드 종료 --------------------------
    contentsVO.setIp(request.getRemoteAddr()); // 접속자 IP
